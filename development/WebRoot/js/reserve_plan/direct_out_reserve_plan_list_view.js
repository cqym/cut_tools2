Ext.onReady(function(){
	...
	var ReservePlanListStore = new Ext.data.Store({
		remoteSort : true,
       proxy: new Ext.data.HttpProxy({url:PATH + '/reservePlan/ReservePlanViewAction.do?ffc=reservePlanList&limit=14&planType=0'}),//调用的动作 
...
var gridCheckSele = new Ext.grid.CheckboxSelectionModel();
	...
	select_quotations_win.render('direct_out_reserve_plan_list_');
