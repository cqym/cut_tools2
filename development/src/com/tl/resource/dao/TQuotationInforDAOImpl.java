...
public class TQuotationInforDAOImpl extends SqlMapClientDaoSupport implements TQuotationInforDAO {
  ...
  public int countByExample(TQuotationInforExample example) {
    Integer count = (Integer) getSqlMapClientTemplate().queryForObject("t_quotation_infor.ibatorgenerated_countByExample", example);
  ...
  public int deleteByExample(TQuotationInforExample example) {
    int rows = getSqlMapClientTemplate().delete("t_quotation_infor.ibatorgenerated_deleteByExample", example);
    return rows;
  }
  ...
  public int deleteByPrimaryKey(String id) {
    ...
    key.setId(id);
    int rows = getSqlMapClientTemplate().delete("t_quotation_infor.ibatorgenerated_deleteByPrimaryKey", key);
    return rows;
  }
  ...
  public void insert(TQuotationInfor record) {
    getSqlMapClientTemplate().insert("t_quotation_infor.ibatorgenerated_insert", record);
  }
  ...
  public void insertSelective(TQuotationInfor record) {
    getSqlMapClientTemplate().insert("t_quotation_infor.ibatorgenerated_insertSelective", record);
  }
  ...
  public List selectByExample(TQuotationInforExample example) {
    List list = getSqlMapClientTemplate().queryForList("t_quotation_infor.ibatorgenerated_selectByExample", example);
    return list;
  }
  ...
  public TQuotationInfor selectByPrimaryKey(String id) {
    TQuotationInfor key = new TQuotationInfor();
    key.setId(id);
    TQuotationInfor record = (TQuotationInfor) getSqlMapClientTemplate().queryForObject("t_quotation_infor.ibatorgenerated_selectByPrimaryKey", key);
    return record;
  }
   ...
   * @ibatorgenerated  Wed Oct 14 14:13:27 CST 2009
   */
  public int updateByExampleSelective(TQuotationInfor record, TQuotationInforExample example) {
    UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
    int rows = getSqlMapClientTemplate().update("t_quotation_infor.ibatorgenerated_updateByExampleSelective", parms);
    return rows;
  }
   ...
   * @ibatorgenerated  Wed Oct 14 14:13:27 CST 2009
   */
  public int updateByExample(TQuotationInfor record, TQuotationInforExample example) {
    UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
    int rows = getSqlMapClientTemplate().update("t_quotation_infor.ibatorgenerated_updateByExample", parms);
    return rows;
  }
  ...
  public int updateByPrimaryKeySelective(TQuotationInfor record) {
    int rows = getSqlMapClientTemplate().update("t_quotation_infor.ibatorgenerated_updateByPrimaryKeySelective", record);
    return rows;
  }
  ...
  public int updateByPrimaryKey(TQuotationInfor record) {
    int rows = getSqlMapClientTemplate().update("t_quotation_infor.ibatorgenerated_updateByPrimaryKey", record);
    return rows;
  }
  ...
  private static class UpdateByExampleParms extends TQuotationInforExample {
    ...
    public UpdateByExampleParms(Object record, TQuotationInforExample example) {
      super(example);
      this.record = record;
    }
  ...
  public int updateStatus(String id, int i) {
    ...
    record.setStatus(i);
    record.setId(id);
    int rows = getSqlMapClientTemplate().update("t_quotation_infor.updateStatus", record);
    return rows;
  }
  ...
  @Override
  public int getTryTools2UploadApplyCount(Map<String, Object> params) {
    Integer in = (Integer) this.getSqlMapClientTemplate().queryForObject("t_quotation_infor.getTryTools2UploadApplyCount", params);
    return in.intValue();
  }

  @Override
  public BigDecimal getSumYuDingAndShiDaoMoneyByCustomerCode(String customerCode) {
    BigDecimal m = (BigDecimal) getSqlMapClientTemplate().queryForObject("t_quotation_infor.getSumYuDingAndShiDaoMoneyByCustomerCode", customerCode);
    return m;
  }

  @Override
  public List getQuosOverDate(Map para) {
    // TODO Auto-generated method stub
    return this.getSqlMapClientTemplate().queryForList("quotation.QuosOverDateSql", para);
  }

  @Override
  public int getQuosCountDeliveryOverDateSql(Map params) {
    Integer in = (Integer) this.getSqlMapClientTemplate().queryForObject("quotation.QuosCountOverDateSql", params);
    return in.intValue();
  }
}