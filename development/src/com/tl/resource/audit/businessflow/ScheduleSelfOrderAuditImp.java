...
public class ScheduleSelfOrderAuditImp implements IAuditBusinessObject {
  ...
  private ScheduleSelfOrderService scheduleSelfOrderService = (ScheduleSelfOrderService) SystemInstance.getInstance().getBean(
    "ScheduleSelfOrderServiceImpl");
  ...
  public void loadBo(String id) {
    ...
    bo.addProperty("url", "/js/orders/purchaseOrder/purchaseOrderWin.js");
  }
  ...
  public void setScheduleSelfOrderService(ScheduleSelfOrderService scheduleSelfOrderService) {
