...
public class TContractProductDetailDAOImpl extends SqlMapClientDaoSupport implements TContractProductDetailDAO {
  ...
  @Override
  public List<TContractProductDetail> selectContractDetailOfPriceChange(String contractId) {
    // TODO Auto-generated method stub
    return getSqlMapClientTemplate().queryForList("t_contract_product_detail.selectContractDetailOfPriceChange", contractId);
  }

  @Override
  public Integer countConDetailNoAcc(String conId) {
    // TODO Auto-generated method stub
    Integer rows = (Integer) getSqlMapClientTemplate().queryForObject("t_contract_product_detail.countConDetailNoAcc", conId);
    return rows;
  }
