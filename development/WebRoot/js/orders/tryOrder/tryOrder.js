																	...
																	var win = new Ext.ffc.PurchaseOrder.cOSupplierWin({
																		...
																		callBackMethod:function(suppid){
																			...
																			loadOrderWindowByConsult({
																					    title:'预定采购订单',
																					    listGrid:cut_tools.t_order.index_grid,
																					    loadDataParam:{quotationId:quotationId,supplierId:suppid,brand:brand,leaf:1,loadActionMethod:'consultTryQuo',toolsTypeName:toolsTypeName}
																			});
																		}
																	});
																	win.show();  
				...
				listeners: {
					'click' : function(){
							...
							Ext.Ajax.request({
								...
								params: { ids: ids ,'method':'submitTryOrder'},
									success: function(response){
...
//								store.baseParams.ownContactPerson = form.ownContactPerson;
	...
	cut_tools.t_order.index_win.render('try_orders');
	Ext.ffc.ResizeManager.addResizeObject(cut_tools.t_order.index_win);
})
