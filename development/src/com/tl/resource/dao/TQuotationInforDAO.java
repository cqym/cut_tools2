...
public interface TQuotationInforDAO {
   ...
   * @ibatorgenerated  Wed Oct 14 14:13:27 CST 2009
   */
  int updateByExampleSelective(TQuotationInfor record, TQuotationInforExample example);
  ...
  int getTryTools2UploadApplyCount(Map<String, Object> params);

  BigDecimal getSumYuDingAndShiDaoMoneyByCustomerCode(String customerCode);

  List getQuosOverDate(Map para);

  int getQuosCountDeliveryOverDateSql(Map params);
}