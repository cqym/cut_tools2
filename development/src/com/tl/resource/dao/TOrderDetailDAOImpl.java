...
public class TOrderDetailDAOImpl extends SqlMapClientDaoSupport implements TOrderDetailDAO {
  ...
  public List<OrderDetialsDto> getContractOrderDetailsListHasFileHasRemainAmount(Map<String, Object> parmMap) {
    ...
    list = this.getSqlMapClientTemplate().queryForList("t_order_detail.getContractOrderDetailsListHasFileHasRemainAmount", parmMap);
    return list;
  }
  ...
  public List<OrderDetialsDto> getOrderDetailsListsOfHasFileData(Map<String, Object> parmMap) {
    List<OrderDetialsDto> list = new ArrayList<OrderDetialsDto>();
    list = this.getSqlMapClientTemplate().queryForList("t_order_detail.getOrderDetailsListsOfHasFileData", parmMap);
    return list;
  }
  ...
  @Override
  public List<OrderDetialsDto> getOrderDetailsHasReserveInfor(String orderId) {
    List<OrderDetialsDto> list = new ArrayList<OrderDetialsDto>();
