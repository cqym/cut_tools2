...
public class TProductSortDAOImpl extends SqlMapClientDaoSupport implements TProductSortDAO {
  ...
  public int countByExample(TProductSortExample example) {
    Integer count = (Integer) getSqlMapClientTemplate().queryForObject("t_product_sort.ibatorgenerated_countByExample", example);
  ...
  public int deleteByExample(TProductSortExample example) {
    int rows = getSqlMapClientTemplate().delete("t_product_sort.ibatorgenerated_deleteByExample", example);
    return rows;
  }
  ...
  public int deleteByPrimaryKey(String id) {
    ...
    key.setId(id);
    int rows = getSqlMapClientTemplate().delete("t_product_sort.ibatorgenerated_deleteByPrimaryKey", key);
    return rows;
  }
  ...
  public void insert(TProductSort record) {
    getSqlMapClientTemplate().insert("t_product_sort.ibatorgenerated_insert", record);
  }
  ...
  public void insertSelective(TProductSort record) {
    getSqlMapClientTemplate().insert("t_product_sort.ibatorgenerated_insertSelective", record);
  }
  ...
  public List selectByExample(TProductSortExample example) {
    List list = getSqlMapClientTemplate().queryForList("t_product_sort.ibatorgenerated_selectByExample", example);
    return list;
  }
  ...
  public TProductSort selectByPrimaryKey(String id) {
    TProductSort key = new TProductSort();
    key.setId(id);
    TProductSort record = (TProductSort) getSqlMapClientTemplate().queryForObject("t_product_sort.ibatorgenerated_selectByPrimaryKey", key);
    return record;
  }
   ...
   * @ibatorgenerated  Wed Oct 14 14:13:27 CST 2009
   */
  public int updateByExampleSelective(TProductSort record, TProductSortExample example) {
    UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
    int rows = getSqlMapClientTemplate().update("t_product_sort.ibatorgenerated_updateByExampleSelective", parms);
    return rows;
  }
  ...
  public int updateByExample(TProductSort record, TProductSortExample example) {
    UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
    int rows = getSqlMapClientTemplate().update("t_product_sort.ibatorgenerated_updateByExample", parms);
    return rows;
  }
  ...
  public int updateByPrimaryKeySelective(TProductSort record) {
    int rows = getSqlMapClientTemplate().update("t_product_sort.ibatorgenerated_updateByPrimaryKeySelective", record);
    return rows;
  }
  ...
  public int updateByPrimaryKey(TProductSort record) {
    int rows = getSqlMapClientTemplate().update("t_product_sort.ibatorgenerated_updateByPrimaryKey", record);
    return rows;
  }
  ...
  public List<TProductSort> getProductSortByPage(Map<String, Object> parmMap) {
    List<TProductSort> list = getSqlMapClientTemplate().queryForList("t_product_sort.getProductSortByPage", parmMap);
    return list;
  }

  @Override
  public int getProductSortTotal(Map para) {
    Integer count = (Integer) getSqlMapClientTemplate().queryForObject("t_product_sort.getProductSortTotal", para);
    return count.intValue();
  }
