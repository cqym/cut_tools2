...
<div id="searchReserve_mat"></div>
<div id="reserveViewPort_mat"></div>
<div id="reserveGird_mat"></div>



<script type="text/javascript" 	src="<%=path%>/js/baseInfo/mat_accountsInfoDetailWindow.js"></script>
<!-- 公司信息列表 -->
<script type="text/javascript" 	src="<%=path%>/js/baseInfo/mat_reserveList.js"></script>
