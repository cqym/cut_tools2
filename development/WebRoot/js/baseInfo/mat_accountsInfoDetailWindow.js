...
function changeMatAccountType(value) {
		switch (value) {
			case 0 :
...
/**
 * 帐页信息列表
 * @class Ext.zhj.accountsInfoDetail.MatAccountsInfoList
 * @extends Ext.grid.GridPanel
 */
Ext.zhj.accountsInfoDetail.MatAccountsInfoList = Ext.extend(Ext.grid.GridPanel, {
	reserveId : null,
	constructor : function(_cfg) {
		...
		var ds = new Ext.data.JsonStore({
					url : PATH + '/baseInfo/matAccountsInfoListByReserveIdAction.do',
		...
		Ext.zhj.accountsInfoDetail.MatAccountsInfoList.superclass.constructor.call(this, {
			bodyStyle : 'width:100%',
			height : 330,
			enableHdMenu : false,
			border : false,
...
/**
 *  库存对应的帐页信息窗口
 * @class Ext.zhj.MatAccountsInfoDetailWindow
 * @extends Ext.Window
 */
Ext.zhj.MatAccountsInfoDetailWindow = Ext.extend(Ext.Window, {
	reserveId : null,
	...
	constructor : function(_cfg) {
		...
		Ext.apply(this, _cfg);
		this.accountsInfoList = new Ext.zhj.accountsInfoDetail.MatAccountsInfoList({
					reserveId : this.reserveId
				});
		
		this.accountsInfoList.getStore().reload();

		Ext.zhj.MatAccountsInfoDetailWindow.superclass.constructor.call(this, {
					title : "查看产品库存对应的帐页详细",
					width : 1050,
					height : 400,
					plain : true,
