...
var  selectForm3 = new Ext.FormPanel({
                        ...
                        items:[
                            ...
                            items:[
								...
								{columnWidth:0.12,items: [{xtype:'datefield',fieldLabel: '至',name: 'endDate',anchor:'100%', format:'Y-m-d'}]},
...
Ext.apply(_config, getConfig());
    ...
    var grid = new Ext.grid.GridPanel({
        ...
        columns: [new Ext.grid.RowNumberer(),//自动行号
			...
			{header: "确认时间", width: 100, sortable: true, dataIndex: 'confirmDate',
		...
		tbar:[{
				...
				listeners : {
					'click' : function(obj) {
						...
						window.open(PATH + "/outStock/outStockOutExcelAction.do?ffc=expertList2Excel&outStockType=1&" + para.join("&"));
					}
				}
        	},*/{
        		text:'导出列表',
